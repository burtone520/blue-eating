...
return(
    ...
    <img src={`data:image/jpeg;base64,${recipes.imageOfProduct}`} alt="" />
        </div>
        <div className="Recipe-details">
            <h1 className="Recipe-Title">{recipes.recipeName}</h1>
            <p className="cookingTime">Cooking time: {randomNumber}</p>
            <p className="creator">Creator:Brilynd</p>
        </div>
        <div className="Recipe-Ingredients">
            <p className="IngredientsHeader">Ingredients:</p>
            {recipes.ingredients!=undefined&& recipes.ingredients.map(item=>{
                return(
        ...
        <div className="Recipe-Directions">
            <h1>Directions: How to Make {recipes.recipeName}</h1>
